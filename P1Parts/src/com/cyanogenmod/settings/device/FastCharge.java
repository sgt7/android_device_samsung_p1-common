...
public class FastCharge implements OnPreferenceChangeListener {
    ...
    private static final String FILE = "/sys/class/misc/fast_charge/enable_fast_charge";
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE, sharedPrefs.getString(DeviceSettings.KEY_FAST_CHARGE, "0"));
    }
